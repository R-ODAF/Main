...
params:
  ...
  group_filter: ["BaP"] #!r NA # Which group will this report be done on?
...
for (x in 1:nrow(contrasts)) {	## for all comparisons to be done	
 ...
 # Save the normalized counts and the list of DEGs
	...
	write.table(DECounts_spike, file = paste0(FileName, "_failed_quantile_table.txt"), sep = "\t", quote = FALSE)
	write.table(DECounts_spike, file = paste0(FileName, "_DEspikes_table.txt"), sep = "\t", quote = FALSE)
